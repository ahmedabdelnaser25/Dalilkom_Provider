    ...
    <main>
          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-input
                col="6"
                type="text"
                :placeholder="$t('SIDENAV.News_tap.name')"
      ...
      <div class="table_title_wrapper">
        <div class="title_text_wrapper">
          <h5>{{ $t("SIDENAV.News_tap.title") }}</h5>
          <button
        ...
        <div
          ...
          v-if="$can('news_tapes create', 'news_tapes')"
        >
          <router-link to="/news_tapes/create">
            {{ $t("SIDENAV.News_tap.add") }}
          </router-link>
        </div>
      </div>
      <!--  =========== End:: Table Title =========== -->
      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <a-tooltip
              placement="bottom"
              v-if="$can('news_tapes edit', 'news_tapes')"
            >
              <template slot="title">
            ...
            <a-tooltip
              placement="bottom"
              v-if="$can('news_tapes delete', 'news_tapes')"
            >
              <template slot="title">
  ...
  data() {
    return {
      ...
      tableHeaders: [
        ...
        {
          text: this.$t("SIDENAV.News_tap.name"),
          value: "content",
          align: "center",
          sortable: false,
        },
        // {
        //   text: this.$t("SIDENAV.News_tap.type"),
        //   value: "type",
        //   align: "center",
        //   sortable: false,
        // },
  ...
  methods: {
    ...
    async submitFilterForm() {
      if (this.$route.query.page !== "1") {
        await this.$router.push({ path: "/news_tapes/all", query: { page: 1 } });
      }
      this.setTableRows();
    },
    async resetFilter() {
      ...
      try {
        let res = await this.$axios({
          ...
          params: {
            ...
            content: this.filterOptions.name
          },
        });
        this.loading = false;
    ...
    // ===== Start:: End
    editItem(item) {
      this.$router.push({ path: `/news_tapes/edit/${item.id}` });
    },
    // ===== End:: End
    ...
    async confirmDeleteItem() {
      try {
        await this.$axios({
          method: "DELETE",
          url: `news-tapes/${this.itemToDelete.id}`,
        });
