        ...
        <div class="row">
          ...
          <div class="col-12" v-if="data.orderType === 'service'">
            ...
            <div class="row">
              ...
              <base-input v-if="data.serviceImplementationTime" col="6" type="text"
                :placeholder="$t('PLACEHOLDERS.serviceImplementationTime')" v-model.trim="data.serviceImplementationTime"
                readonly />
          ...
          <div class="col-12" v-if="data.orderArea &&
            ...
            <div class="row">
              ...
              <base-input col="6" type="text" :placeholder="$t('PLACEHOLDERS.district')" v-model.trim="data.orderDistrict"
                readonly />
          ...
          <div class="col-12" v-if="data.clientImage ||
            ...
            <div class="row">
              ...
              <base-input v-if="data.clientPhone" col="4" type="text" :placeholder="$t('PLACEHOLDERS.phone')"
          ...
          <div class="col-12" v-if="data.driverImage || data.driverName || data.driverPhone">
            ...
            <div class="row">
              ...
              <base-input v-if="data.driverPhone" col="6" type="text" :placeholder="$t('PLACEHOLDERS.phone')"
