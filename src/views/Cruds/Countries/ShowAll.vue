    ...
    <main>
          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-input
                col="6"
                type="text"
                :placeholder="$t('SIDENAV.Countries.name')"
      ...
      <div class="table_title_wrapper">
        <div class="title_text_wrapper">
          <h5>{{ $t("SIDENAV.Countries.showAll") }}</h5>
          <button
        ...
        <div
          ...
          v-if="$can('countries create', 'countries')"
        >
          <router-link to="/countries/create">
            {{ $t("SIDENAV.Countries.add") }}
          </router-link>
        </div>
      </div>
      <!--  =========== End:: Table Title =========== -->
      ...
      >
        ...
        <template v-slot:[`item.is_active`]="{ item }">
          ...
          <div
            ...
            dir="ltr"
            style="z-index: 1"
            v-if="$can('countries activate', 'countries')"
          >
            <v-switch
              class="mt-2"
              color="success"
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            <a-tooltip
              placement="bottom"
              v-if="$can('countries show', 'countries')"
            >
              <template slot="title">
            ...
            <a-tooltip
              placement="bottom"
              v-if="$can('countries edit', 'countries')"
            >
              <template slot="title">
            ...
            <a-tooltip
              placement="bottom"
              v-if="$can('countries delete', 'countries')"
            >
              <template slot="title">
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      getAreasData: "ApiGetsModule/allAreasData",
    }),
