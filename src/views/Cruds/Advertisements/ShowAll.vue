    ...
    <main>
          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-input
                col="6"
                type="text"
                :placeholder="$t('SIDENAV.advertisement.name')"
      ...
      <div class="table_title_wrapper">
        ...
        <div
          ...
          v-if="$can('ad_spaces create', 'ad_spaces')"
        >
      ...
      >
        ...
        <template v-slot:[`item.ad`]="{ item }">
          <div class="table_image_wrapper">
            <h6 class="text-danger" v-if="!item.ad">
              {{ $t("TABLES.noData") }}
            </h6>

            <button class="my-1" @click="showImageModal(item.ad)" v-else>
              <img
                class="rounded"
                :src="item.ad"
                :alt="item.name"
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            <a-tooltip
              placement="bottom"
              v-if="$can('ad_spaces show', 'ad_spaces')"
            >
              <template slot="title">
            ...
            <a-tooltip
              placement="bottom"
              v-if="$can('ad_spaces edit', 'ad_spaces')"
            >
              <template slot="title">
            ...
            <a-tooltip
              placement="bottom"
              v-if="$can('ad_spaces delete', 'ad_spaces')"
            >
              <template slot="title">
  ...
  methods: {
    ...
    async confirmDeleteItem() {
      try {
        await this.$axios({
          method: "DELETE",
          url: `ad-spaces/${this.itemToDelete.id}`,
        });
