    ...
    <main>
          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-select-input
                ...
                v-model.trim="filterOptions.area_id"
                @input="getCountries"
              />
              <!-- End:: Name Input -->
      ...
      <div class="table_title_wrapper">
        <div class="title_text_wrapper">
          <h5>{{ $t("SIDENAV.Districts.showAll") }}</h5>
          <button
  ...
  data() {
    return {
      ...
      tableHeaders: [
        ...
        {
          text: this.$t("PLACEHOLDERS.neighborhood_name"),
          value: "name",
          sortable: false,
          align: "center",
        },
      ...
      try {
        let res = await this.$axios({
          ...
          params: {
            ...
            region: this.filterOptions.area_id?.id,
            city: this.filterOptions.country_id?.id,
