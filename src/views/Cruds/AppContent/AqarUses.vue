<template>
  <div class="crud_form_wrapper">
    ...
    <div class="form_title_wrapper">
      <h4>{{ $t("PLACEHOLDERS.terms_of_use_in_akarplus_app") }}</h4>
    </div>
    <!-- End:: Title -->
...
export default {
  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        let res = await this.$axios({
          method: "GET",
          url: `settings?key=Terms_of_use_in_the_dalilkum_Plus_application`,
        });
        // Start:: Set Data
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("key", "Terms_of_use_in_the_dalilkum_Plus_application");
