          ...
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <base-input
                ...
                v-model.trim="filterOptions.productName"
              />
              ...
              <base-input
                ...
                v-model="filterOptions.providerName"
              />
              <!-- end provider Name -->
              <!-- start created At -->
              <base-input col="4" type="text"
              :placeholder="$t('TABLES.Products.created_at')"
              v-model="filterOptions.createdAt" />
              <!-- end created At -->
...
export default {
  ...
  methods: {
    ...
    async resetFilter() {
      ...
      this.filterOptions.createdAt = null;
    ...
    async confirmDeleteItem() {
      ...
      try {
        await this.$axios.post(
          `product-update-requests/${this.itemToDelete?.id}`,
          REQUEST_DATA
        );
    ...
    async approvedProviders(item) {
      ...
      try {
        await this.$axios({
          method: "POST",
          url: `product-update-requests/${item.id}`,
          data: REQUEST_DATA,
        });
        this.setTableRows();
